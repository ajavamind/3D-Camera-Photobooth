 ...
 * is automtically generated by the Processing source pre-processor.
 *  It will pick the first fullScreen or size() and move to settings() commenting it out in setup()
 */
...
public void setup() {
  ...
  fullScreen(RENDERER, 1);  // photo booth main display on monitor 1
...
public void draw() {
  ...
  if (monitor[MAIN_DISPLAY].format.equals("3DHW")) {
    convertScreen();
  }
}
